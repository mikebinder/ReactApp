		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'jumbotron', style: { 'backgroundColor': 'transparent','backgroundRepeat': 'no-repeat', 'backgroundPosition': 'center', 'backgroundAttachment': 'fixed', 'padding-top': '25px' } },
						React.createElement(
							'h2',
							{ className: 'text-center', style: { 'color': 'black', 'fontSize': '54px' } },
